function [p,ellipse]=phantom3dm(varargin)
...
if(numel(n)==1)
	...
	p = zeros(n(2), n(1), n(3));
	for d=1:3
		rng{d} = ( (0:n(d)-1)-(n(d)-1)/2 ) / ((n(d)-1)/2);
	end
	isCube = 0;
end

[x,y,z] = meshgrid(rng{1},-rng{2},rng{3});
...
e = [];
defaults = {'shepp-logan', 'modified shepp-logan', 'yu-ye-wang', 'mr flat'};
...
function e = mr_flat
%
%   This head phantom is the same as Modified Shepp-Logan except
%	  the outer ring is less bright.
%
%
%         A      a     b     c     x0      y0      z0    phi  theta    psi
%        -----------------------------------------------------------------
e =    [  1  .6900  .920  .810      0       0       0      0      0      0
        -.5  .6624  .874  .780      0  -.0184       0      0      0      0
        -.5  .1100  .310  .220    .22       0       0    -18      0     10
        -.5  .1600  .410  .280   -.22       0       0     18      0     10
         .2  .2100  .250  .410      0     .35    -.15      0      0      0
         .2  .0460  .046  .050      0      .1     .25      0      0      0
         .2  .0460  .046  .050      0     -.1     .25      0      0      0
         .2  .0460  .023  .050   -.08   -.605       0      0      0      0
         .2  .0230  .023  .020      0   -.606       0      0      0      0
         .2  .0230  .046  .020    .06   -.605       0      0      0      0 ];
