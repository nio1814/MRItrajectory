...
*/
void generateSpirals(struct VariableDensity *vd, float fieldOfView, float spatialResolution, float readoutDuration, float samplingInterval, int interleaves, enum SpiralType sptype, float floretAngle, float fovfilt, float gmax, float smax);
